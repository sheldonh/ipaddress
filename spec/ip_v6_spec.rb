...
describe "IP::V6" do
  describe "#new" do
    it "takes a CIDR string" do
      a = IP::V6.new("fc00:1000:abcd:efff:0000:0000:0000:0001/64")
    ...
    it "takes an unmasked address string and assumes a mask size of 128" do
      a = IP::V6.new("0000:0000:0000:0000:0000:0000:0000:0001")
    ...
    it "accepts compressed inner zeroes" do
      a = IP::V6.new("fc00:1000::1000:1/7")
  ...
  describe "#address" do
    it "returns the address in RFC5952 format if :string is given" do
      a = IP::V6.new(0x2001_0470_1f09_0553_0000_0000_0000_0001, 64)
  ...
  describe "#broadcast" do
    it "returns the broadcast address as an IP::V6 if :instance is given" do
      a = IP::V6.new("fc00::/7")
      a.broadcast(:instance).should == IP::V6.new("fdff:ffff:ffff:ffff:ffff:ffff:ffff:ffff/7")
    end
    ...
    it "returns itself if it is a broadcast address" do
      a = IP::V6.new("fdff:ffff:ffff:ffff:ffff:ffff:ffff:ffff/7")
  ...
  describe "#network" do
    it "returns the network address as an IP::V6 if :instance is given" do
      a = IP::V6.new("fc00::1/7")
      a.network(:instance).should == IP::V6.new("fc00::/7")
    end
    ...
    it "defaults to :instance if presentation is not given" do
      a = IP::V6.new("fc00::1/7")
      a.network.should == IP::V6.new("fc00::/7")
    end
  ...
  describe ".aggregate" do
    it "returns an array of one IP::V6 that aggregates two given addresses if they are adjacent" do
      aggregates = IP::V6.aggregate [IP::V6.new("fc00::/8"), IP::V6.new("fd00::/8")]
    ...
    it "copes with unordered addresses if input order is given as :unsorted" do
      ...
      aggregates = IP::V6.aggregate(nets, :unsorted)
    ...
    it "avoids unnecessary instance creation by reusing unaggregated instances from the passed array" do
      ...
      aggregates = IP::V6.aggregate(nets)
